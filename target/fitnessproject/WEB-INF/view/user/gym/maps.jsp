...
<meta name="viewport" content="initial-scale=1.0, user-scalable=no">
    ...
    <script type="text/javascript" src="/fitnessproject/js/angular/maps/model.js"></script>
	<script type="text/javascript" src="/fitnessproject/js/angular/maps/controller.js"></script>
