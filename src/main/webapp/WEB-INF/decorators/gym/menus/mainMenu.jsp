<nav class="navbar navbar-default" role="navigation">
  <div class="container">
    <div class="col-sm-6 col-xs-12 main_menu">
    	<a href="${pageContext.request.contextPath}/gym/index">
    		<img src="/fitnessproject/img/icon/site_icon.png" alt="site icon">
    		<span class="title_font">Fitness Project</span>
    	</a>
    </div>
    <div class="col-md-offset-2 col-md-4 col-sm-offset-1 col-sm-5 hidden-xs">
    	<ul class="nav navbar-nav" role="navigation">
    		<li class=""><a href="${pageContext.request.contextPath}/gym/index">Olá, {_gym.info.name_}!</a></li>
    		<li class="dropdown">
